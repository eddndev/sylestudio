{{-- 
    =================================================================
    ARCHIVO: resources/views/newsletter/unsubscribed.blade.php
    =================================================================
--}}
@extends('layouts.app')
    ...
    <div class="flex items-center justify-center min-h-screen px-6 py-24">
        <div class="text-center max-w-lg">
            ...
            <div class="prose prose-xl mx-auto mt-4 text-on-surface/80">
                <p>
                    Hemos procesado tu solicitud. Ya no recibirás más correos de nuestra parte. Siempre serás bienvenido de vuelta.
                </p>
            </div>
            <div class="mt-10">
